import speech_recognition as sr    #To detect the microphone audio and print it
...
from PIL import Image, ImageTk     #for opening, manipulating, and saving many different image file formats.
from itertools import count        # functions that work on iterators
import tkinter as tk               # fast and easy way to create GUI applications
                ...
                #recognize speech using Sphinx
                        try:
                                ...
                                if(a.lower()=='goodbye'):
                                    ...
                                    lbl = ImageLabel(root)
                                    lbl.pack()
                                    lbl.load(r'C:\Users\rishi\OneDrive\Desktop\Audio to sign language converter\Audio to sign language converter\ISL_Gifs.format(a.lower())')
                                    root.mainloop()
                                else:
...
while 1:
  image   = "signlang1.jpg"
  msg="AUDIO TO SIGN LANGUAGE CONVERSION"
  choices = ["LIVE AUDIO","EXIT","RECORDED"]
